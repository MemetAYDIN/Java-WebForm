...
.widget-reservation-box button {  margin:13px 0 10px 0; font-size:15px; background:#0f085f; border:none; color:#fff; font-weight:bold; padding:8px; width:100%; border-radius:10px;}
...
<body>
 ...
 <%
    ...
    String password=(String)session.getAttribute("password");
        ...
        {
    		JOptionPane.showMessageDialog(null, "Everthing looking good!!");
    	...
    	{
    	    JOptionPane.showMessageDialog(null, "Please Full fill username and pasword!!!");
    	}
    			...
    			<div class="widget-reservation-box ">
					<div class="form1"> 
                        ...
                        <div class="res">
                            ...
                            <input autocomplete="off" type="password" id="password" name="password" placeholder="Password"value=<%=password %>/>
                        </div>
